...
<head>
    ...
    <?php wp_head(); ?>
    <link rel="stylesheet" type="text/css" href="/wp-content/themes/frisieur/_assets/fonts/stylesheet.css"/>
</head>
<body <?php body_class(); ?>>
            ...
            <form method="post">
                ...
                <div class="input">
                    ...
                    <input type="text" name="appointment-date"
                           placeholder="<?php _e('Appointment date', 'martanian'); ?>"
                           class="appointment-datepicker appointment-popup-form-datepicker" readonly/>
                ...
                <div class="input approximate-time-input">
                    ...
                    <input type="text" name="approximate-time"
                           placeholder="<?php _e('Approximate time', 'martanian'); ?>" class="approximate-time" readonly
                           data-timebox-id="1"/>

                    <div class="clear">
                    </div>

                    <div class="approximate-time-box animated fadeInDown <?php echo $time_type == '24h' ? 'approximate-time-box-24h' : '' ?>"
                         data-timebox-id="1">
                ...
                <textarea placeholder="<?php _e('Additional notes...', 'martanian'); ?>"
                          name="additional-notes"></textarea>
                <input type="button" value="<?php _e('Make an appointment!', 'martanian'); ?>"
                       class="button button-brown submit-appointment"/>
